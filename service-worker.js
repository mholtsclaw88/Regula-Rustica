const CACHE = 'regula-rustica-premium-foundation-v1';
const ASSETS = [
  './', './index.html', './styles.css?v=premium-foundation-v1', './housekeeping.css?v=ledger-page-v1', './cloud-auth.css', './onboarding.css?v=onboarding-v4', './housekeeping-data.js?v=calendar-projections-v1', './task-foundation.js?v=record-lifecycle-v1', './record-documents.js?v=homestead-identity-v1', './journal-foundation.js?v=journal-consolidation-v3', './form-selector.js?v=responsible-party-selectors-v2', './records-relationships.js?v=data-entry-forms-v2', './ui-refinements.js?v=ledger-page-v1', './ui-refinements-core.js?v=ledger-page-v1', './ledger-receipt-modal.js?v=data-entry-forms-v2', './ledger-allocations.js?v=data-entry-forms-v2', './ledger-allocation-display.js?v=multi-record-ledger-v1', './app.js?v=ledger-page-v1', './onboarding.js?v=onboarding-v4', './cloud-auth.js?v=premium-foundation-v1',
