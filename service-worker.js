const CACHE = 'regula-rustica-monastic-palette-v2';
const ASSETS = [
  './', './index.html', './styles.css?v=monastic-palette-v1', './housekeeping.css?v=monastic-palette-v1', './cloud-auth.css', './housekeeping-data.js?v=today-operational-v4', './task-foundation.js?v=record-lifecycle-v1', './record-documents.js?v=local-attachments-v1', './journal-foundation.js?v=journal-consolidation-v3', './form-selector.js?v=responsible-party-selectors-v2', './records-relationships.js?v=data-entry-forms-v2', './ui-refinements.js?v=monastic-icons-v2', './ui-refinements-core.js?v=yield-ledger-ui-v1', './ledger-receipt-modal.js?v=data-entry-forms-v2', './ledger-allocations.js?v=data-entry-forms-v2', './ledger-allocation-display.js?v=multi-record-ledger-v1', './app.js?v=monastic-icons-v1', './cloud-auth.js',
