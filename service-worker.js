const CACHE = 'regula-rustica-recurring-task-skip-v2';
const ASSETS = [
  './', './index.html', './styles.css?v=mobile-primary-nav-v6', './housekeeping.css?v=chore-window-editor-v1', './cloud-auth.css', './housekeeping-data.js?v=record-task-lifecycle-v2', './task-foundation.js?v=recurring-task-skip-v2', './record-documents.js?v=local-attachments-v1', './journal-foundation.js?v=journal-consolidation-v3', './records-relationships.js?v=daily-workflow-debug-v1', './ui-refinements.js?v=mobile-primary-nav-v4', './ui-refinements-core.js?v=journal-documents-v1', './ledger-receipt-modal.js?v=ledger-form-v1', './ledger-allocations.js?v=ledger-form-v1', './ledger-allocation-display.js?v=reporting-v1', './app.js?v=recurring-task-skip-v2', './cloud-auth.js',
