const CACHE = 'regula-rustica-record-task-ux-v4';
const ASSETS = [
  './', './index.html', './styles.css', './housekeeping.css?v=record-task-ux-v4', './cloud-auth.css', './housekeeping-data.js?v=unified-tasks-v1', './task-foundation.js?v=record-task-ux-v4', './records-relationships.js', './ui-refinements.js?v=record-ui-v1', './ui-refinements-core.js?v=record-ui-v1', './ledger-receipt-modal.js?v=ledger-form-v1', './ledger-allocations.js?v=ledger-form-v1', './ledger-allocation-display.js?v=reporting-v1', './app.js?v=record-task-ux-v4', './cloud-auth.js',
