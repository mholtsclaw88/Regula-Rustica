const CACHE = 'regula-rustica-onboarding-v4';
const ASSETS = [
  './', './index.html', './styles.css?v=homestead-identity-v3', './housekeeping.css?v=calendar-projections-v1', './cloud-auth.css', './onboarding.css?v=onboarding-v4', './housekeeping-data.js?v=calendar-projections-v1', './task-foundation.js?v=record-lifecycle-v1', './record-documents.js?v=homestead-identity-v1', './journal-foundation.js?v=journal-consolidation-v3', './form-selector.js?v=responsible-party-selectors-v2', './records-relationships.js?v=data-entry-forms-v2', './ui-refinements.js?v=monastic-icons-v3', './ui-refinements-core.js?v=yield-ledger-ui-v1', './ledger-receipt-modal.js?v=data-entry-forms-v2', './ledger-allocations.js?v=data-entry-forms-v2', './ledger-allocation-display.js?v=multi-record-ledger-v1', './app.js?v=onboarding-v3', './onboarding.js?v=onboarding-v4', './cloud-auth.js?v=homestead-identity-v2',
