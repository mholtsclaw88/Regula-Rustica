const CACHE = 'regula-rustica-data-entry-forms-v2';
const ASSETS = [
  './', './index.html', './styles.css?v=mobile-primary-nav-v6', './housekeeping.css?v=data-entry-forms-v2', './cloud-auth.css', './housekeeping-data.js?v=record-task-lifecycle-v2', './task-foundation.js?v=disabled-recurring-visibility-v1', './record-documents.js?v=local-attachments-v1', './journal-foundation.js?v=journal-consolidation-v3', './records-relationships.js?v=data-entry-forms-v2', './ui-refinements.js?v=data-entry-forms-v2', './ui-refinements-core.js?v=journal-documents-v1', './ledger-receipt-modal.js?v=data-entry-forms-v2', './ledger-allocations.js?v=data-entry-forms-v2', './ledger-allocation-display.js?v=multi-record-ledger-v1', './app.js?v=data-entry-forms-v2', './cloud-auth.js',
