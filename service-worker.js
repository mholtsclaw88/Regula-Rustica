const CACHE = 'regula-rustica-routine-stabilization-v1';
const ASSETS = [
  './', './index.html', './styles.css', './housekeeping.css?v=routines-v4', './cloud-auth.css', './housekeeping-data.js?v=routines-v4', './routines-data.js?v=routines-v4', './routine-stabilization.js?v=stabilization-v2', './records-relationships.js', './ui-refinements.js?v=ledger-receipts-v1', './ui-refinements-core.js?v=ledger-receipts-v2', './ledger-receipt-modal.js?v=ledger-receipts-v3', './ledger-allocations.js?v=allocations-v5', './ledger-allocation-display.js?v=allocations-v1', './app.js?v=routines-v4', './cloud-auth.js',
