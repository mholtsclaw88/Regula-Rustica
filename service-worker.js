const CACHE = 'regula-rustica-yield-page-v2';
const ASSETS = [
  './', './index.html', './styles.css?v=compact-mastheads-v2', './housekeeping.css?v=yield-page-v2', './cloud-auth.css', './onboarding.css?v=onboarding-v4', './housekeeping-data.js?v=calendar-projections-v1', './task-foundation.js?v=record-lifecycle-v1', './record-documents.js?v=homestead-identity-v1', './journal-foundation.js?v=journal-consolidation-v3', './form-selector.js?v=responsible-party-selectors-v2', './records-relationships.js?v=data-entry-forms-v2', './ui-refinements.js?v=record-detail-v1', './ui-refinements-core.js?v=yield-ledger-ui-v1', './ledger-receipt-modal.js?v=data-entry-forms-v2', './ledger-allocations.js?v=data-entry-forms-v2', './ledger-allocation-display.js?v=multi-record-ledger-v1', './app.js?v=yield-page-v2', './onboarding.js?v=onboarding-v4', './cloud-auth.js?v=homestead-identity-v2',
