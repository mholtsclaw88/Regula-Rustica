const CACHE = 'regula-rustica-mobile-primary-nav-v1';
const ASSETS = [
  './', './index.html', './styles.css?v=mobile-primary-nav-v1', './housekeeping.css?v=journal-consolidation-v2', './cloud-auth.css', './housekeeping-data.js?v=record-task-lifecycle-v2', './task-foundation.js?v=record-task-lifecycle-v2', './record-documents.js?v=local-attachments-v1', './journal-foundation.js?v=journal-consolidation-v3', './records-relationships.js', './ui-refinements.js?v=mobile-primary-nav-v1', './ui-refinements-core.js?v=journal-documents-v1', './ledger-receipt-modal.js?v=ledger-form-v1', './ledger-allocations.js?v=ledger-form-v1', './ledger-allocation-display.js?v=reporting-v1', './app.js?v=journal-consolidation-v5', './cloud-auth.js',
