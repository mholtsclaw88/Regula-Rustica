const CACHE = 'regula-rustica-cyril-dialog-copy-v1';
const ASSETS = [
  './', './index.html', './styles.css?v=cyril-assisted-entry-v1', './housekeeping.css?v=cyril-dialog-copy-v1', './cloud-auth.css', './onboarding.css?v=standard-onboarding-v1', './housekeeping-data.js?v=calendar-projections-v1', './task-foundation.js?v=record-lifecycle-v1', './record-documents.js?v=homestead-identity-v1', './journal-foundation.js?v=journal-consolidation-v3', './form-selector.js?v=responsible-party-selectors-v2', './records-relationships.js?v=data-entry-forms-v2', './ui-refinements.js?v=cyril-record-matching-v1', './ui-refinements-core.js?v=ledger-page-v1', './ledger-receipt-modal.js?v=cyril-receipt-reader-v2', './ledger-allocations.js?v=ledger-api-v2', './ledger-allocation-display.js?v=ledger-api-v2', './cellarer-assisted-entry.mjs?v=cyril-dialog-copy-v1', './cellarer-receipt-reader.mjs?v=cyril-dialog-copy-v1', './cellarer-consult.mjs?v=cyril-dialog-copy-v1', './app.js?v=account-cloud-dialogs-v1', './onboarding.js?v=account-cloud-dialogs-v1', './cloud-auth.js?v=account-cloud-dialogs-v1',
