...
(function(){
 ...
 load('ui-refinements-core.js?v=ui-cleanup-v1',()=>{if(typeof window.openModal==='function')loadLedgerTools();else window.addEventListener('load',loadLedgerTools,{once:true});});
}());
