...
(function(){
 ...
 function loadLedgerTools(){load('ledger-receipt-modal.js?v=ledger-receipts-v3',null,'data-ledger-receipt-modal');load('ledger-allocations.js?v=allocations-v4',null,'data-ledger-allocations');load('ledger-allocation-display.js?v=allocations-v1',null,'data-ledger-allocation-display');}
